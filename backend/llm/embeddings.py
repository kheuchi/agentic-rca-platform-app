"""Embedding model setup with fallback or explicit provider switching."""
...
def resolve_embedding_provider_mode(
    ...
    *,
    ...
    """Resolve which provider mode to use for embeddings."""
...
def get_embedding_model():
    """Return an embedding model with fallback or explicit provider switching."""
